...
namespace LambdaMutantML_Nivel3.Domain.UseCases
{
    public class MutantUseCase
    {
        ...
        {
            IEnumerable<Mutant> mutants = mutantRepository.Gets(true);
            IEnumerable<Mutant> humans = mutantRepository.Gets(false);
        ...
        private async Task<bool> SaveDNA(Mutant mutant)
        {
